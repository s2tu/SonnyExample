...
<c:if test="${taxiuser == null }">
	<jsp:forward page="acesssdenied.jsp"></jsp:forward>
</c:if>
		...
		<div id="bookingContent">
			...
			<form action="BookingServlet" method="POST">
				<table border=1>
					...
					<tr><td><label>Pickup Place</label></td><td>
					...
					<tr><td><label>Drop Place</label></td><td>
						<select id="dropplace" name="dropplace" required>
							<option value="">Select City</option>
							<option value="Toronto">Toronto</option>
							<option value="Waterloo">Waterloo</option>
						</select>
